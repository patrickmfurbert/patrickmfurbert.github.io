<script>
  ...
  let profilePhoto;
  try {
    profilePhoto = "/patrick-photo.jpg";
  } catch (e) {
    // If photo doesn't exist, use initials as fallback
    profilePhoto = null;
  }
...
<div class="container fade-in">
  ...
  <section id="summary" class="animate-on-scroll">
    ...
    <p>
      ...
      through healthcare management roles. Proven track record of mentoring
      teams, resolving complex technical issues, and collaborating effectively
      with cross-functional stakeholders. Published author with a commitment to
      continuous learning and community engagement through FIRST Robotics
      mentorship.
    </p>
  </section>
  ...
  <section id="experience" class="animate-on-scroll">
    ...
    <div class="experience-item">
      ...
      <div class="company">Paychex - Rochester, NY</div>
      <ul>
        <li>
          Collaborate in an Agile team of 10 developers to update, test, and
          deploy applications/starter libraries in OpenShift environment
        </li>
        <li>
          Analyze and resolve defects/incidents while providing timely feedback
          to internal customers
        </li>
        <li>
          Conduct research spikes on new libraries for Solution Lead to evaluate
          for integration
        </li>
        <li>
          Worked with team triangle for planning out work for team for multiple
          increments
        </li>
        <li>
          Collaborated with Solution Lead and Senior Developer on application
          designs
        </li>
    ...
    <div class="experience-item">
      <div class="job-title">
        <span>Inpatient Dialysis RN</span>
        <span>April 2020 - February 2022</span>
      </div>
      <div class="company">URMC Strong Memorial Hospital - Rochester, NY</div>
      <ul>
        <li>
          Provided initiation, monitoring, and documentation of hemodialysis
          treatments for acute and chronic dialysis patients
        </li>
        <li>
          Assessed patient response to HD treatment therapy and intradialytic
          infusions, adjusting treatment plans as indicated by Nephrology
          Provider
        </li>
      </ul>
    </div>
    ...
    <div class="experience-item">
      <div class="job-title">
        <span>Operating Room RN III</span>
        <span>April 2013 - March 2020</span>
      </div>
      <div class="company">URMC Strong Memorial Hospital - Rochester, NY</div>
      <ul>
        <li>
          Served in multiple roles: Staff RN, Primary Service Nurse, and POD
          Coordinator
        </li>
        <li>
          Completed daily OR nursing staffing assignments for surgical
          subspecialties
        </li>
        <li>
          Collaborated with Sterile Processing/Supply Chain to minimize supply
          and instrument delays
        </li>
        <li>
          Provided professional guidance, supervision, and leadership to 15+ Pod
          Members
        </li>
      </ul>
    </div>
  ...
  <section id="education" class="animate-on-scroll">
    ...
    <div class="education-item">
      ...
      <div class="school">Oregon State University, Corvallis, OR</div>
      <p>GPA: 3.7/4.0</p>
    </div>

    <div class="education-item">
      <div class="degree">
        <span>Bachelor of Science, Nursing</span>
        <span>December 2015</span>
      </div>
      <div class="school">University of Rochester, Rochester, NY</div>
    </div>

    <div class="education-item">
      <div class="degree">
        <span>Bachelor of Science, Microbiology</span>
        <span>June 2008</span>
      </div>
      <div class="school">University of Rochester, Rochester, NY</div>
    </div>
  ...
  <section id="publications" class="animate-on-scroll">
    <h2>Publications</h2>
    <p>
      Furbert, P., Lu, C., Winograd, N., & DeLouise, L. (2008). Label-free
      optical detection of peptide synthesis on a porous silicon
      scaffold/sensor.
      <em>Langmuir</em>, 24(6), 2908-2915. doi: 10.1021/la703053h
    </p>
  </section>
